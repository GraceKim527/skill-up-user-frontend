...
export default function MentoringDetailLayout() {
  return (
    <div className={styles.mentoringDetailLayout}>
      <StickyApplySection />
      <div className={styles.mentoringDetailContent}>
        <div className={styles.mentoringDetailContentItem}>
        ...
        <div className={styles.mentoringOtherEvent}>
          <Text typography="head3_m_24" color="black" as="h3">
            이런 행사는 어떠세요?
          </Text>
          {/* 목업데이터 */}
          <div className={styles.mentoringOtherEventList}>
